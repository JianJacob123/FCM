                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: isMobile 
                          ? Row(
                              children: [
                                const Expanded(flex: 1, child: Text('Vehicle', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14))),
                          ...
                          : Row(
                              children: [
                                const Expanded(flex: 1, child: Text('Vehicle ID', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold))),
